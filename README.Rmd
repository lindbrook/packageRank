...
For ['packageRank'](https://CRAN.R-project.org/package=packageRank) functions, the calendar date (e.g. "2021-01-01") is the unit of observation. However, because the typical use case involves getting the most recent data (i.e., the _latest_ log), time zone differences can come into play.

Let's say that it's 09:01 on 01 January 2021 and you want to compute the rank percentile for ['ergm'](https://CRAN.R-project.org/package=ergm) for 31 December 2020. You might enter the following expression:
