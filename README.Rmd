...
Note that a new feature in R version 4.0.3 appears to _intermittently_ prevent the successful downloading of log files. Reverting to version 4.0.2 is the working solution. For those interested, details are available [here.](https://github.com/lindbrook/packageRank/blob/master/docs/R403.error.md)
