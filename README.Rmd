...
NOTE (2020 October 15): R version 4.0.3 seems to create a problem that prevents the downloading of log files. Reverting back to version 4.0.2 is the working solution. For those interested, details are available [here.](https://github.com/lindbrook/packageRank/blob/master/docs/R403.error.md)
