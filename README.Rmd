...
Second, to help you check/remember when logs are posted in your location, there's `logInfo()`. The function checks to see if "today's" log is posted on RStudio's server and if "today's" results have been computed in 'cranlogs'. Using the optional `logInfo(list.available = TRUE)`, the function will compute the dates of the last available download log and 'cranlogs' result by looking at the previous week.
