...
* [VI Et Cetera](#vi---et-cetera) discusses country code top-level domains (e.g., countryPackage() and packageCountry()), the use of memoization, the effect of time zones, the internet connection time out problem, and the recent (and ongoing) spikes in the download of the Windows version of the R application on Sundays.
...
The graph above for [R downloads](#packages--r) plots the daily downloads of the R application broken down by platform (Mac, Source, Windows). In it, you can seek a weekly pattern with mid-week peaks and weekend troughs. However, on Sunday, 06 November 2022 this pattern was broken. 

On that day, and each subsequent Sunday, there have been noticeable spikes in downloads of the Windows version of the R application. 
