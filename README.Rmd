...
* [V Data Fix A](#v---data-fixes) discusses two problems with download counts. The first stems from problems with the logs from the end of 2012 and the beginning of 2013. These are fixed in `fixDate_2012()` and `fixCranlogs()`. 
* [VI Data Fix B](#vi---data-fixes) discusses a problem with ['cranlogs'](https://CRAN.R-project.org/package=cranlogs) that doubles or triples the number of R application downloads between 2023-09-13 and 2023-10-02. This is fixed in `fixRCranlogs()`.
