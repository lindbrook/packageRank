...
* [VI Data Fixes B](#vi---data-fixes-b) discusses a "doubling" of R application download counts that appeared in the second half of September through the beginning of October 2023. By default, a fix is incorporated in `packageRank::cranDownloads()`.
...
Assuming the logs are "correct", why this problem emerged is unclear. For now, `packageRank::cranDownloads()` fixes this by default via the `fix.cranlogs = TRUE` argument.
