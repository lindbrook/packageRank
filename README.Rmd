...
Second, to help you check/remember when logs are posted in your location, there's `logPostInfo()`. For the time it's run, you'll get the date of the latest available log along with the expected local and UTC times when the log should be posted to RStudio's server.
