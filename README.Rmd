...
When you don't pass any packages (i.e., packages = NULL), you'll get a count of the total package downloads from CRAN.
...
When you pass "R", you'll get a count of total downloads of the R application.
