...
Second, when plotting `cranDownloads()` two gray polygons to highlight those dates are added to the graph and are labelled with a "⌀" (empty set) on the top axis. Third, smoothers ignore these missing dates.
