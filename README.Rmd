...
All plot are available as both base R and 'ggplot2' graphs. By default, single packages use base graphics while multiple packages use 'ggplot2'. You can override these defaults via the "graphics" argument in the plot() method.
