...
* [‘packageRank'](https://CRAN.R-project.org/package=packageRank) has two upstream dependencies: 1) RStudio's [CRAN package download logs](http://cran-logs.rstudio.com/) and 2) Gábor Csárdi's [‘cranlogs'](https://CRAN.R-project.org/package=cranlogs) R package. The former record traffic that passes through the [“0-Cloud” mirror]() at cloud.r-project.org (formerly RStudio's CRAN mirror). The latter is a software interface to a database that computes R and R package download counts using the [“0-Cloud” mirror]() logs.
