...
[![GitHub\_Status\_Badge](https://img.shields.io/badge/GitHub-0.3.5.9125-red.svg)](https://github.com/lindbrook/packageRank/blob/master/NEWS)
...
### VI - download count filters

#### smallFilter0() and tripletFilter()

“small” and “medium” singletons, pairs, triplets
...
`packageRank()` is currently limited to individual calendar days. To
reduce the bottleneck of re-downloading logs, ‘packageRank’ makes use of
