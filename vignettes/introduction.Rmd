...
Possibly due to the use of memoization, a vignette with R code examples does not pass all CRAN tests (Debian platform specifically.) For documenation about this package, see the README on CRAN or [GitHub](https://github.com/lindbrook/packageRank).
