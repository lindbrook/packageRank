...
To visualize a package's position in the distribution on a given day's downloads, use `packageRankTime()`. Currently, only two time frames are available: "last-week" and "last-month".
