...
sequenceFilterB <- function(dat, packages, ymd, delta.time = 10) {
  ...
  removeSequencesB(dat, arch.pkg.history, delta.time = delta.time)
}
...
removeSequencesB <- function(dat, arch.pkg.history, delta.time = 10) {
